...
const cSpaces = {
    getSpaces: async (request, response) => {
        try {
    ...
    getSpace: async (request, response) => {
        try {
    ...
    getSpacesperType: async (request, response) => {
        try {
            const id = Number(request.params.id);
    ...
    getSpacesCapacity: async (request, response) => {
        try {
            const id = Number(request.params.id);
    ...
    getSpacesperLocation: async (request, response) => {
        try {
            const id = Number(request.params.id);
    ...
    getSpaceAvailable: async (request, response) => {
        try {
...
//# sourceMappingURL=cSpaces.js.map