...
1. Asignar una nomenclatura adeacuada a las entidades y sus atributos.(usar guion bajo para asignar nombres)
...
1. Corrida de datos en Excell _(No es necesario pero para validar la logica del sistema, con minino de 10 inserciones por entidad)_

#### Glosario:

1. **_ED:_** Entidad de Datos
1. **_EC:_** Entidad Catalogo
1. **_PK:_** Llave primaria
1. **_FK:_** Llave Secuandaria
1. **_EP:_** Entidad Pivote
1. **_UQ:_** Campo Unico

### Ejemplo:

# sistema de reservas de espacios de coworking (SREC)
...
INSERT INTO Users ( membershipType_id, role_id, dateCreate, name, lastname, mail, password, age ) VALUES ( 3, 2, NOW(), 'Jorge Luis', 'Valerio Chalas', 'CoworkingAdmin@mail.com', "$2b$10$geGW4XMlho/WKKLvRkWI/.JdMwFz5v0N8R8i.psV7T1pJmpoNQDRa", 25); ---- Password: Coworking123.
